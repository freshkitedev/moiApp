        ...
        <div class="background-color3">
          ...
          <form onSubmit={Submitfun} >
            <div class="form-group input-container2 frm1">
              ...
              <input type="text" class="form-control input-container2" id="name" placeholder="Enter your name" onChange={(e) => { setName(e.target.value) }} value={Name} required></input>
            </div>
            <div class="form-group input-container2 frm1">
            ...
            <div class="form-group input-container2 frm1">
              ...
              <textarea class="form-control input-container2" id="address" rows="3" placeholder="Enter your address" onChange={(e) => { setAddress(e.target.value) }} value={Address} required></textarea>
            </div>
            <div class="form-group input-container2 frm1">
              <label for="payment" class="tt3">Payment :    </label>
              <input class="form-control" id="payment" placeholder="Enter your amount" onChange={(e) => { setPayment(e.target.value) }} value={Moipayment} required></input>
            </div>
